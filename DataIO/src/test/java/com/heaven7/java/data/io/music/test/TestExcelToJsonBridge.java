...
public class TestExcelToJsonBridge {
    ...
    @Test
    public void testV1() {
      //  E:\tmp\bugfinds\music3.xlsx 0 E:\tmp\bugfinds\music_cuts2\cuts.txt E:\tmp\bugfinds\out_music6 E:\tmp\bugfinds\music_cuts2 2
        String[] args = {
    ...
    public void testMerge() {
        ...
        MergedExcelToBridge parentBridge = new MergedExcelToBridge(mergeOut, simpleName, bridgeV1, bridgeV2);
